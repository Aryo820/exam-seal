      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Material(
                ...
                child: CheckboxListTile(
                  ...
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text(
                    'Saya telah menguji Form sampai submit dan memeriksa seluruh ketentuan di atas.',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                      fontWeight: FontWeight.w700,
            ...
            const Text(
              'QR baru dapat ditampilkan pada langkah T04 setelah status ini berhasil disimpan.',
